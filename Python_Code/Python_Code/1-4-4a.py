...
student_file = os.path.join(directory, 'taylor.jpg')
...
earth_small = earth_img.resize((55, 80)) #eye width and height measured in plt
...
student_img.paste(earth_small, (25, 360), mask=earth_small) 
# Display
